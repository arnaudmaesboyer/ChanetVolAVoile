...
<form action="<?php echo base_url('gestionClient/UpdateClient/'.$client[0]->idCust.'')?>" method="post">
                                              <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                <a type="button" class="btn btn-secondary" href="<?php echo site_url('gestionClient/AffichageChangePassword') ?>">Changer mot de passe</a>
                                                </div>
                                              </div>
                                              <div class="form-row">
                                                <div class="form-group col-md-6">
